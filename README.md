...
基于 **Binance U本位合约** 的全自动量化交易系统，核心策略为**快捞**（15分钟涨>6%做多/跌>6%做空 + 动态锁仓止盈）。
...
| 循环 | 频率 | 职责 |
|------|------|------|
| **快捞循环** | 每2分钟 | 扫描500+币种，15min涨>6%做多/跌>6%做空，小仓追涨杀跌 |
| **趋势采集循环** | 每30分钟 | 采集币安广场+X.com → AI摘要 → 微信通知 |
| **汇总报表循环** | 每分钟检查 | 到点发送1h/3h/6h/12h/24h微信汇总 |
...
| ≥ 30% | **K线动态计算** | 1h振幅×趋势系数×4 = 回撤空间 |

## 微信消息

| 周期 | 时间 | 内容 |
|------|------|------|
| **趋势摘要** | 每30分钟 | 广场+X最新动态 → AI摘要 → 微信通知 |
| 1小时 | 每个整点 | 盈亏/多空比 |
| 3小时 | 每3h整点 | 盈亏/多空比 |
